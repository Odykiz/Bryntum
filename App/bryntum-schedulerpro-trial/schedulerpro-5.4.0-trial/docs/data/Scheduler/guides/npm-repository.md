...
```shell
$ yarn add @bryntum/scheduler@npm:@bryntum/scheduler-trial@5.4.0
$ yarn add @bryntum/scheduler-angular@5.4.0
```
...
"dependencies": {
  ...
  "@bryntum/scheduler-angular": "5.4.0"
}
```
...
```shell
$ yarn add @bryntum/scheduler@5.4.0
$ yarn add @bryntum/scheduler-angular@5.4.0
```
...
"dependencies": {
  ...
  "@bryntum/scheduler": "file:./lib/bryntum-scheduler-trial-5.4.0.tgz"
}
```
...
"dependencies": {
  ...
  "@bryntum/scheduler": "file:./lib/bryntum-scheduler-5.4.0.tgz"
}
```
...
npm ERR! 404
npm ERR! 404 ‘@bryntum/scheduler@5.4.0’ is not in the npm registry.
```
