...
<a href="#SchedulerPro/guides/integration/react/guide.md#build-and-run-local-demos" class="b-card"><i class="fab b-fa-react"></i>Build and run React demos</a>
</div>
...
"dependencies": {
  ...
  "@bryntum/schedulerpro-react": "5.4.0",
  "react": "18.2.0",
  "react-dom": "18.2.0",
  "react-scripts": "5.0.1"
},
